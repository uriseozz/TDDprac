...
### 목표
1. UI 없이 백엔드 서버 API 구축하는 방법을 익히기
2. Spring 3계층 (Controller, Service, Repository) 역할 별로 구분해서 구현할 수 있어요. 특히, Service 에서 복잡한 비즈니스 로직을 처리하기
3. Spring Data JPA 를 사용하여 요구사항에 맞춰 DB 를 이용하기
4. 주어진 테스트 코드를 통해 과제에 요구되는 사항들을 검증하는 능력을 키우기
<br>
